...
- [x] Verify with `cargo test -p lyng-types`.
...
- [x] Verify with `cargo test -p lyng-builtins --lib`.
...
- [x] Verify with `cargo test -p lyng-builtins --lib` and `cargo test -p lyng-tests temporal`.
...
- [ ] Verify each family with `cargo test -p lyng-builtins --lib` and `cargo run --release -p lyng-test262 -- --filter built-ins/Temporal/<Family> --report /tmp/lyng-test262-temporal-<family>.md -j 4`.
  - [x] Verified `Instant` with `cargo test -p lyng-builtins --lib`, `cargo test -p lyng-tests temporal::instant`, `cargo test -p lyng-tests temporal`, and Test262 `built-ins/Temporal/Instant` (906 passed, 24 failed, 0 panicked).
  - [x] Verified `Duration` with `cargo test -p lyng-builtins --lib`, `cargo test -p lyng-tests temporal::duration`, and Test262 `built-ins/Temporal/Duration` (868 passed, 198 failed, 0 panicked).
  - [x] Verified `PlainMonthDay` with `cargo test -p lyng-builtins --lib`, `cargo test -p lyng-tests temporal::plain_month_day`, `cargo test -p lyng-tests temporal::plain_shared`, `cargo test -p lyng-tests temporal::plain_date::temporal_plain_date_converts_to_partial_plain_dates`, and Test262 `built-ins/Temporal/PlainMonthDay` (392 passed, 6 failed, 0 panicked).
  - [x] Verified `PlainYearMonth` with `cargo test -p lyng-builtins --lib`, `cargo test -p lyng-tests temporal::plain_year_month`, `cargo test -p lyng-tests temporal::plain_shared`, `cargo test -p lyng-tests temporal::plain_date::temporal_plain_date_converts_to_partial_plain_dates`, and Test262 `built-ins/Temporal/PlainYearMonth` (954 passed, 56 failed, 0 panicked).
  - [x] Verified `PlainTime` with `cargo test -p lyng-builtins --lib`, `cargo test -p lyng-tests temporal::plain_time`, `cargo test -p lyng-tests temporal::plain_date_time`, `cargo test -p lyng-tests temporal::zoned_date_time`, and Test262 `built-ins/Temporal/PlainTime` (974 passed, 12 failed, 0 panicked).
  - [x] Verified `PlainDate` with `cargo test -p lyng-builtins --lib`, `cargo test -p lyng-tests temporal::plain_date`, and Test262 `built-ins/Temporal/PlainDate` (1244 passed, 48 failed, 0 panicked).
  - [x] Verified `PlainDateTime` with `cargo test -p lyng-builtins --lib`, `cargo test -p lyng-tests temporal::plain_date_time`, and Test262 `built-ins/Temporal/PlainDateTime` (1378 passed, 156 failed, 0 panicked).
  - [x] Verified `ZonedDateTime` with `cargo test -p lyng-builtins --lib`, `cargo test -p lyng-tests temporal::zoned_date_time`, and Test262 `built-ins/Temporal/ZonedDateTime` (1482 passed, 312 failed, 0 panicked).
  - [x] Verified `Temporal.Now` with `cargo test -p lyng-builtins --lib` and `cargo test -p lyng-tests temporal_now` (4 passed).
...
- [ ] Verify with `cargo test -p lyng-vm`, `cargo test -p lyng-tests`, and targeted Test262 slices for moved dynamic behavior.
  - [x] Verified the dynamic-import and class-helper owner split with `cargo test -p lyng-vm` (241 passed, doc-tests 0).
  - [x] Verified the function-helper owner split with `cargo test -p lyng-vm` (241 passed, doc-tests 0), `cargo test -p lyng-tests` (880 passed, doc-tests 0), and Test262 `built-ins/Function` (885 passed, 0 failed, 0 panicked).
  - [x] Verified the object-helper owner split with `cargo test -p lyng-vm` (241 passed, doc-tests 0), `cargo test -p lyng-tests` (880 passed, doc-tests 0), and Test262 `built-ins/Object` (6734 passed, 0 failed, 0 panicked).
  - [x] Verified the template-helper owner split with `cargo test -p lyng-vm` (241 passed, doc-tests 0), `cargo test -p lyng-tests template` (14 passed), `cargo test -p lyng-tests` (880 passed, doc-tests 0), Test262 `language/expressions/template-literal` (114 passed, 0 failed, 0 panicked), and Test262 `language/expressions/tagged-template` (44 passed, 4 failed, 0 panicked; unchanged from pre-move baseline).
  - [x] Verified the dispatch-context bridge split with `cargo test -p lyng-vm` (241 passed, doc-tests 0) and `cargo test -p lyng-tests` (880 passed, doc-tests 0).
  - [x] Verified the function-allocation owner split with `cargo test -p lyng-vm` (241 passed, doc-tests 0) and `cargo test -p lyng-tests` (880 passed, doc-tests 0).
  - [x] Verified the dispatch-context support split with `cargo test -p lyng-vm` (241 passed, doc-tests 0) and `cargo test -p lyng-tests` (880 passed, doc-tests 0).
  - [x] Verified the dispatch-context internal routing split with `cargo test -p lyng-vm` (241 passed, doc-tests 0) and `cargo test -p lyng-tests` (880 passed, doc-tests 0).
  - [x] Verified the dispatch-context public routing split with `cargo test -p lyng-vm` (241 passed, doc-tests 0) and `cargo test -p lyng-tests` (880 passed, doc-tests 0).
  - [x] Verified the class/private-field helper split with `cargo test -p lyng-vm` (241 passed, doc-tests 0) and `cargo test -p lyng-tests` (880 passed, doc-tests 0).
  - [x] Verified the class `super` helper split with `cargo test -p lyng-vm` (241 passed, doc-tests 0) and `cargo test -p lyng-tests` (880 passed, doc-tests 0).
...
- [x] Verify with `cargo test -p lyng-gc`, `cargo test -p lyng-env`, and targeted weak-reference/shared-memory integration tests when affected.
  - [x] Verified the GC arena record split with `cargo test -p lyng-gc` (29 passed, doc-tests 0) and `cargo test -p lyng-env` (37 passed, doc-tests 0).
  - [x] Verified the GC arena storage split with `cargo test -p lyng-gc` (29 passed, doc-tests 0) and `cargo test -p lyng-env` (37 passed, doc-tests 0).
  - [x] Verified the GC weak/finalization state split with `cargo test -p lyng-gc` (29 passed, doc-tests 0) and `cargo test -p lyng-env` (37 passed, doc-tests 0).
  - [x] Verified the GC store-helper split with `cargo test -p lyng-gc` (29 passed, doc-tests 0) and `cargo test -p lyng-env` (37 passed, doc-tests 0).
...
- [x] Verify with `cargo test -p lyng-builtins --lib` and `cargo test -p lyng-tests`.
  - [x] Verified the descriptor installer split with `cargo test -p lyng-builtins --lib` (32 passed) and `cargo test -p lyng-tests` (880 passed, doc-tests 0).
  - [x] Verified the global descriptor split with `cargo test -p lyng-builtins --lib` (32 passed), `cargo test -p lyng-tests` (880 passed, doc-tests 0), and `cargo fmt --all --check`.
  - [x] Verified the bootstrap test-module split with `cargo test -p lyng-builtins --lib` (32 passed), `cargo test -p lyng-tests` (880 passed, doc-tests 0), and `cargo fmt --all --check`.
  - [x] Verified the metadata facade split with `cargo test -p lyng-builtins --lib` (32 passed), `cargo test -p lyng-tests` (880 passed, doc-tests 0), and `cargo fmt --all --check`.
  - [x] Verified the public family prototype-link split with `cargo test -p lyng-builtins --lib` (32 passed), `cargo test -p lyng-tests` (880 passed, doc-tests 0), and `cargo fmt --all --check`.
  - [x] Verified the public family intrinsic split with `cargo test -p lyng-builtins --lib` (32 passed), `cargo test -p lyng-tests` (880 passed, doc-tests 0), and `cargo fmt --all --check`.
...
- [x] Verify with `cargo test -p lyng-objects`, `cargo test -p lyng-vm`, and focused object/proxy/array Test262 slices when behavior-affecting.
  - [x] Verified the named-property cache split with `cargo test -p lyng-objects` (49 passed, doc-tests 0), `cargo test -p lyng-vm` (241 passed, doc-tests 0), and `cargo fmt --all --check`.
  - [x] Verified the exotic-object helper split with `cargo test -p lyng-objects` (49 passed, doc-tests 0), `cargo test -p lyng-vm` (241 passed, doc-tests 0), and `cargo fmt --all --check`.
  - [x] Verified the integrity helper split with `cargo test -p lyng-objects` (49 passed, doc-tests 0), `cargo test -p lyng-vm` (241 passed, doc-tests 0), and `cargo fmt --all --check`.
  - [x] Verified the indexed-element split with `cargo test -p lyng-objects define_own_property`, `cargo test -p lyng-objects own_property_keys`, `cargo test -p lyng-objects element`, `cargo test -p lyng-objects` (49 passed, doc-tests 0), `cargo test -p lyng-vm` (241 passed, doc-tests 0), `cargo test -p lyng-tests objects` (45 passed, 835 filtered), and `cargo fmt --all --check`.
  - [x] Verified the named-property split with `cargo test -p lyng-objects named_property`, `cargo test -p lyng-objects define_own_property`, `cargo test -p lyng-objects own_property_keys`, `cargo test -p lyng-objects` (49 passed, doc-tests 0), `cargo test -p lyng-vm` (241 passed, doc-tests 0), and `cargo fmt --all --check`.
  - [x] Verified the ordinary algorithm split with `cargo test -p lyng-objects ordinary_internal_methods`, `cargo test -p lyng-objects proxy_internal_methods`, `cargo test -p lyng-objects define_own_property`, `cargo test -p lyng-objects` (49 passed, doc-tests 0), `cargo test -p lyng-vm` (241 passed, doc-tests 0), `cargo test -p lyng-tests objects` (45 passed, 835 filtered), and `cargo fmt --all --check`.
  - [x] Verified the exotic-family split with `cargo test -p lyng-objects` (49 passed, doc-tests 0), `cargo test -p lyng-vm` (241 passed, doc-tests 0), `cargo test -p lyng-tests objects` (45 passed, 835 filtered), `cargo test -p lyng-tests shared_memory` (4 passed, 876 filtered), and `cargo fmt --all --check`.
...
- [x] Verify with `cargo test -p lyng-env`, `cargo test -p lyng-vm`, and `cargo test -p lyng-tests`.
  - [x] Verified the cluster-handle split with `cargo test -p lyng-env backing_store` (7 passed, 30 filtered), `cargo test -p lyng-env shared_memory` (1 passed, 36 filtered), `cargo test -p lyng-env` (37 passed, doc-tests 0), and `cargo fmt --all --check`.
  - [x] Verified the job facade split with `cargo test -p lyng-env runtime_job_ids_fail_loudly_on_overflow` (1 passed, 36 filtered), `cargo test -p lyng-env` (37 passed, doc-tests 0), `cargo test -p lyng-vm promise` (23 passed, 218 filtered), and `cargo fmt --all --check`.
  - [x] Verified the disposal facade split with `cargo test -p lyng-env disposal` (2 passed, 35 filtered), `cargo test -p lyng-env` (37 passed, doc-tests 0), `cargo test -p lyng-vm using` (9 passed, 232 filtered), and `cargo fmt --all --check`.
  - [x] Verified the promise facade split with `cargo test -p lyng-env promise` (6 passed, 31 filtered), `cargo test -p lyng-env` (37 passed, doc-tests 0), `cargo test -p lyng-vm promise` (23 passed, 218 filtered), and `cargo fmt --all --check`.
  - [x] Verified the environment facade split with `cargo test -p lyng-env environment` (8 passed, 29 filtered), `cargo test -p lyng-env module_environment` (2 passed, 35 filtered), `cargo test -p lyng-env` (37 passed, doc-tests 0), `cargo test -p lyng-vm environment` (7 passed, 234 filtered), `cargo test -p lyng-tests environment` (3 passed, 877 filtered), and `cargo fmt --all --check`.
  - [x] Verified the module-record facade split with `cargo test -p lyng-env module` (3 passed, 34 filtered), `cargo test -p lyng-vm module` (36 passed, 205 filtered), `cargo test -p lyng-tests module` (6 passed, 874 filtered), `cargo test -p lyng-env` (37 passed, doc-tests 0), and `cargo fmt --all --check`.
  - [x] Verified the execution-context facade split with `cargo test -p lyng-env execution_context` (2 passed, 35 filtered), `cargo test -p lyng-env eval_execution_context` (1 passed, 36 filtered), `cargo test -p lyng-vm environment` (7 passed, 234 filtered), `cargo test -p lyng-tests environment` (3 passed, 877 filtered), `cargo test -p lyng-env` (37 passed, doc-tests 0), and `cargo fmt --all --check`.
  - [x] Verified the realm facade split with `cargo test -p lyng-env realm` (2 passed, 35 filtered), `cargo test -p lyng-env default_realm` (1 passed, 36 filtered), `cargo test -p lyng-builtins --lib` (32 passed), `cargo test -p lyng-vm environment` (7 passed, 234 filtered), `cargo test -p lyng-env` (37 passed, doc-tests 0), and `cargo fmt --all --check`.
  - [x] Verified the weak/finalization facade split with `cargo test -p lyng-env` (37 passed, doc-tests 0), `cargo test -p lyng-vm` (241 passed, doc-tests 0), `cargo test -p lyng-builtins --lib` (32 passed), and `cargo fmt --all --check`.
  - [x] Verified the symbol/string facade split with `cargo test -p lyng-env symbol` (1 passed, 36 filtered), `cargo test -p lyng-vm symbol` (5 passed, 236 filtered), `cargo test -p lyng-vm string` (12 passed, 229 filtered), `cargo test -p lyng-env` (37 passed, doc-tests 0), `cargo test -p lyng-builtins --lib` (32 passed), and `cargo fmt --all --check`.
  - [x] Verified the accounting facade split and final agent split state with `cargo test -p lyng-env accounting` (3 passed, 34 filtered), `cargo test -p lyng-env` (37 passed, doc-tests 0), `cargo test -p lyng-vm` (241 passed, doc-tests 0), `cargo test -p lyng-tests` (880 passed, doc-tests 0), and `cargo fmt --all --check`.
...
- [x] Verify with `cargo test -p lyng-ops`, `cargo test -p lyng-vm`, and focused object/class Test262 slices when behavior-affecting.
  - [x] Verified the object-operation test-module split with `cargo test -p lyng-ops object::tests` (9 passed, 65 filtered) and `cargo fmt --all --check`.
  - [x] Verified the private-element bridge split with `cargo test -p lyng-ops object::tests` (9 passed, 65 filtered), `cargo test -p lyng-vm` (241 passed, doc-tests 0), `cargo test -p lyng-tests class` (71 passed, 809 filtered), and `cargo fmt --all --check`.
  - [x] Verified the receiver-payload split with `cargo test -p lyng-ops object::tests` (9 passed, 65 filtered), `cargo test -p lyng-builtins --lib` (32 passed), `cargo test -p lyng-tests temporal` (165 passed, 715 filtered), and `cargo fmt --all --check`.
  - [x] Verified the primitive-wrapper split with `cargo test -p lyng-ops object::tests` (9 passed, 65 filtered), `cargo test -p lyng-builtins --lib` (32 passed), `cargo test -p lyng-tests temporal` (165 passed, 715 filtered), `cargo test -p lyng-vm` (241 passed, doc-tests 0), and `cargo fmt --all --check`.
  - [x] Verified the conversion and BigInt split with `cargo test -p lyng-ops object::tests` (9 passed, 65 filtered), `cargo test -p lyng-vm` (241 passed, doc-tests 0), `cargo test -p lyng-tests script_core` (165 passed, 715 filtered), and `cargo fmt --all --check`.
  - [x] Verified the typed-array index split with `cargo test -p lyng-ops object::tests` (9 passed, 65 filtered), `cargo test -p lyng-vm` (241 passed, doc-tests 0), `cargo test -p lyng-tests shared_memory` (4 passed, 876 filtered), and `cargo fmt --all --check`.
  - [x] Verified the ordinary-operation split with `cargo test -p lyng-ops object::tests` (9 passed, 65 filtered), `cargo test -p lyng-vm` (241 passed, doc-tests 0), `cargo test -p lyng-tests objects` (45 passed, 835 filtered), and `cargo fmt --all --check`.
  - [x] Verified final Task 10 object-ops coverage with `cargo test -p lyng-ops` (74 passed, doc-tests 0).
...
- [x] Verify current bootstrap and buffer dispatch split.
  - [x] Verified with `cargo test -p lyng-builtins --lib` (32 passed), `cargo test -p lyng-vm` (241 passed, doc-tests 0), `cargo test -p lyng-tests shared_memory` (4 passed, 876 filtered), `cargo fmt --all --check`, Test262 `built-ins/ArrayBuffer` (158 passed, 4 failed, 0 panicked), and Test262 `built-ins/SharedArrayBuffer` (118 passed, 2 failed, 0 panicked).
  - [x] Verified the DataView dispatch split with `cargo test -p lyng-builtins --lib` (32 passed), `cargo test -p lyng-vm` (241 passed, doc-tests 0), `cargo test -p lyng-tests shared_memory` (4 passed, 876 filtered), `cargo fmt --all --check`, and Test262 `built-ins/DataView` (884 passed, 156 failed, 0 panicked).
  - [x] Verified the Atomics dispatch split with `cargo test -p lyng-builtins --lib` (32 passed), `cargo test -p lyng-vm` (241 passed, doc-tests 0), `cargo test -p lyng-tests shared_memory` (4 passed, 876 filtered), `cargo fmt --all --check`, and Test262 `built-ins/Atomics` (416 passed, 4 failed, 0 panicked).
  - [x] Verified the buffer/DataView/Atomics descriptor split with `cargo test -p lyng-builtins --lib` (32 passed), `cargo fmt --all --check`, and combined binary-data follow-up checks before commit.
  - [x] Verified the typed-array storage helper split with `cargo test -p lyng-builtins --lib` (32 passed), `cargo test -p lyng-vm` (241 passed, doc-tests 0), `cargo test -p lyng-tests shared_memory` (4 passed, 876 filtered), `cargo fmt --all --check`, and Test262 `built-ins/TypedArray` (2438 passed, 6 failed, 0 panicked, 416 skipped).
  - [x] Verified the typed-array support and descriptor split with `cargo test -p lyng-builtins --lib` (32 passed), `cargo test -p lyng-vm` (241 passed, doc-tests 0), `cargo test -p lyng-tests shared_memory` (4 passed, 876 filtered), `cargo fmt --all --check`, `git diff --check`, and Test262 `built-ins/TypedArray` (2438 passed, 6 failed, 0 panicked, 416 skipped).
...
- [x] Verify with `cargo test -p lyng-env` (37 passed), `cargo test -p lyng-builtins --lib` (32 passed), `cargo test -p lyng-vm environment` (7 passed, 234 filtered), `cargo fmt --all --check`, and `git diff --check`.
...
- [x] Verify with `cargo test -p lyng-builtins --lib` (32 passed), `cargo test -p lyng-tests array` (53 passed, 827 filtered), `cargo test -p lyng-tests script_core` (165 passed, 715 filtered), `cargo fmt --all --check`, `git diff --check`, and Test262 `built-ins/Array` (5921 passed, 30 failed, 0 panicked, 164 skipped).
...
- [x] Verify with `cargo test -p lyng-builtins --lib` (32 passed), `cargo test -p lyng-tests script_core` (165 passed, 715 filtered), `cargo fmt --all --check`, `git diff --check`, and Test262 `built-ins/Math` (654 passed, 0 failed, 0 panicked, 0 skipped).
...
- [x] Verify with `cargo test -p lyng-builtins --lib` (32 passed), `cargo test -p lyng-tests string` (85 passed, 795 filtered), `cargo fmt --all --check`, `git diff --check`, and Test262 `built-ins/String` (2429 passed, 0 failed, 0 panicked, 14 skipped).
...
- [x] Verify with `cargo test -p lyng-builtins --lib` (32 passed), `cargo test -p lyng-tests string` (85 passed, 795 filtered), Test262 `built-ins/String/prototype/normalize` (28 passed, 0 failed, 0 panicked, 0 skipped), Test262 `built-ins/String/prototype/localeCompare` (26 passed, 0 failed, 0 panicked, 0 skipped), `cargo fmt --all --check`, and `git diff --check`.
...
- [x] Verify with `cargo test -p lyng-builtins --lib` (32 passed), Test262 `built-ins/RegExp/escape` (40 passed, 0 failed, 0 panicked, 0 skipped), `cargo fmt --all --check`, and `git diff --check`.
...
- [x] Verify with `cargo test -p lyng-builtins --lib` (32 passed), Test262 `built-ins/Map` (316 passed, 24 failed, 0 panicked, 65 skipped), Test262 `built-ins/Set` (392 passed, 0 failed, 0 panicked, 372 skipped), `cargo fmt --all --check`, and `git diff --check`.
...
- [x] Verify with `cargo test -p lyng-builtins --lib` (32 passed), `cargo test -p lyng-tests script_core` (165 passed, 715 filtered), Test262 `built-ins/BigInt` (154 passed, 0 failed, 0 panicked, 0 skipped), `cargo fmt --all --check`, and `git diff --check`.
...
- [x] Verify with `cargo test -p lyng-builtins --lib` (32 passed), `cargo test -p lyng-tests date` (91 passed, 789 filtered), `cargo test -p lyng-tests script_core_date` (3 passed, 877 filtered), `cargo test -p lyng-tests script_core_installs_date` (1 passed, 879 filtered), Test262 `built-ins/Date` (1188 passed, 0 failed, 0 panicked, 0 skipped), `cargo fmt --all --check`, and `git diff --check`.
...
- [x] Verify with `cargo test -p lyng-builtins --lib` (32 passed), `cargo test -p lyng-tests regexp` (13 passed, 867 filtered), `cargo test -p lyng-tests string_match` (6 passed, 874 filtered), Test262 `built-ins/RegExp` (2701 passed, 371 failed, 0 panicked, 684 skipped), `cargo fmt --all --check`, and `git diff --check`.
...
- [x] Verify with `cargo test -p lyng-builtins --lib` (32 passed), `cargo test -p lyng-tests regexp` (13 passed, 867 filtered), `cargo test -p lyng-tests regexp_source` (1 passed, 879 filtered), Test262 `built-ins/RegExp/prototype/flags` (30 passed, 0 failed, 0 panicked, 2 skipped), `source` (22 passed, 2 failed, 0 panicked), `global` (20 passed, 0 failed), `hasIndices` (16 passed, 0 failed), `ignoreCase` (20 passed, 0 failed), `dotAll` (16 passed, 0 failed), `unicode` (16 passed, 0 failed), `sticky` (16 passed, 0 failed), `cargo fmt --all --check`, and `git diff --check`.
...
- [x] Verify with `cargo test -p lyng-builtins --lib` (32 passed), `cargo test -p lyng-tests regexp_constructor` (2 passed, 878 filtered), `cargo test -p lyng-tests regexp` (13 passed, 867 filtered), `cargo test -p lyng-tests function_to_string_formats_regexp_species_getter` (1 passed, 879 filtered), Test262 `built-ins/RegExp/Symbol.species` (8 passed, 0 failed, 0 panicked), `built-ins/RegExp/call` (2 passed, 4 failed, 0 panicked), `built-ins/RegExp/is-a-constructor` (2 passed, 0 failed), `built-ins/RegExp/prototype/unicodeSets/uv-flags-constructor` (0 runnable, 2 skipped), `cargo fmt --all --check`, and `git diff --check`.
