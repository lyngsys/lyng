...
Lfunc_begin389:
		// crates/vm/src/vm/dispatch_handlers/property.rs:121
	...
	add x1, x9, x5
		// crates/vm/src/vm/dispatch.rs:236
		if prefix.is_some() {
	cmp w8, #152
	b.ne LBB389_135
	and x8, x2, #0x7ffffffffffffffe
		// crates/vm/src/vm/dispatch.rs:239
	...
	ldrh w23, [x1, #4]
		...
		match self {
	cbz w23, LBB389_18
		// crates/vm/src/vm/dispatch.rs:248
		u16::from(*ra),
	ldrb w10, [x1, #1]
		// crates/vm/src/vm/dispatch.rs:249
		u16::from(*rb),
	ldrb w8, [x1, #2]
	mov w9, #6
	stp w9, w10, [sp, #80]
		// crates/vm/src/vm/dispatch.rs:250
		u16::from(*rc),
	ldrb w9, [x1, #3]
		// crates/vm/src/vm/dispatch_handlers/property.rs:142
...
LBB389_5:
	...
	tbnz w26, #31, LBB389_31
		...
		match self {
	cbz w23, LBB389_13
		// crates/vm/src/vm/feedback.rs:2205
	...
	ldr x9, [x8]
	cmp x9, #10
		// crates/vm/src/vm/feedback.rs:2206
		match site {
	ccmp x9, #4, #2, ne
	b.lo LBB389_106
LBB389_13:
		...
		self.metadata.code
	ldr w2, [x20, #4]
		// crates/vm/src/vm/dispatch/property.rs:440
...
LBB389_15:
	...
	b.ls LBB389_198
		...
		self.ptr.cast().as_non_null_ptr()
	ldr x9, [x21, #24]
		// crates/vm/src/vm/registers.rs:28
...
LBB389_27:
	...
	stp q0, q1, [x20, #48]
	stp q3, q2, [x20, #16]
		// crates/vm/src/vm/dispatch.rs:522
...
LBB389_30:
	...
	b.ne LBB389_63
LBB389_31:
		// crates/vm/src/vm/property_access.rs:1585
	...
	stp x9, x8, [x29, #-128]
	stur x20, [x29, #-112]
		// crates/vm/src/vm/property_access.rs:1592
	...
	ldr w3, [x20, #4]
		...
		self.state.instruction_offset
	ldr w4, [x20, #56]
		// crates/vm/src/vm/property_access.rs:462
	...
	cmp x8, x9
	b.ne LBB389_50
		// crates/vm/src/vm/dispatch.rs:545
	...
	b.ne LBB389_64
LBB389_36:
		// crates/vm/src/vm/dispatch/property.rs:475
	...
	ldr w3, [x20, #4]
		...
		match self {
	cbz w23, LBB389_97
		// crates/vm/src/vm/feedback.rs:2151
		let site = self.feedback_site_for_slot(code, slot?)?;
	ldr x1, [x21, #104]
		// ~/.rustup/toolchains/stable-aarch64-apple-darwin/lib/rustlib/src/rust/library/core/src/num/nonzero.rs:499
		unsafe { intrinsics::transmute_unchecked(self) }
	...
	cmp x9, #10
	b.eq LBB389_98
		// crates/vm/src/vm/feedback.rs:2152
		match site {
	cmp x9, #3
	b.hi LBB389_98
		// crates/vm/src/vm/feedback.rs:2154
		if feedback.monomorphic_named_fast_atom == atom.raw()
	ldr w9, [x8, #1148]
	cmp w9, w26
	b.ne LBB389_168
		// crates/vm/src/vm/feedback.rs:2155
	...
	b.ne LBB389_168
	ldr x10, [x8, #1096]
		// crates/vm/src/vm/dispatch/property.rs:1474
...
LBB389_50:
	...
	b.ne LBB389_60
	cbnz w5, LBB389_60
		// crates/vm/src/vm/dispatch.rs:546
...
LBB389_63:
	mov w5, #2
		// crates/vm/src/vm/property_access.rs:458
	...
	b.eq LBB389_36
LBB389_64:
		// crates/vm/src/vm/dispatch/property.rs:588
	...
	bl lyng_vm::vm::property_access::<impl lyng_vm::vm::Vm>::get_property_from_value
		// crates/vm/src/vm/dispatch/property.rs:590
	...
	cmp x8, x9
	b.ne LBB389_158
		// crates/vm/src/vm/dispatch/property.rs:589
		let Some(value) =
	tbnz w5, #0, LBB389_131
	b LBB389_125
LBB389_68:
		// crates/vm/src/vm/dispatch/property.rs:451
	...
	cmp x8, x9
	b.ne LBB389_73
		// crates/vm/src/vm/dispatch/property.rs:457
	...
	b LBB389_95
LBB389_73:
		// crates/vm/src/vm/dispatch/property.rs:452
...
LBB389_80:
		...
		self.metadata.code
	ldr w2, [x20, #4]
		// crates/vm/src/vm/dispatch/property.rs:489
		if let Some(value) = self.try_keyed_dense_index_load_inline_cache_hit(
	mov x0, x21
	mov x1, x22
	mov x3, x23
	...
	bl lyng_vm::vm::feedback::<impl lyng_vm::vm::Vm>::try_keyed_dense_index_load_inline_cache_hit
	tbnz w0, #0, LBB389_15
		// crates/vm/src/vm/dispatch/property.rs:500
		let value = if let Some(result) = self.mapped_arguments_get(agent, object, index) {
	add x0, sp, #224
	mov x1, x21
	mov x2, x22
	...
	cmp x8, x9
	b.ne LBB389_122
		// crates/vm/src/vm/dispatch/property.rs:508
		Self::try_fast_typed_array_index_value(agent, object, index)
	mov x0, x22
	mov x1, x25
	mov x2, x26
	bl lyng_vm::vm::property_access::<impl lyng_vm::vm::Vm>::try_fast_typed_array_index_value
		// crates/vm/src/vm/dispatch/property.rs:507
		} else if let Some(value) =
	tbz w0, #0, LBB389_127
	mov x27, x1
	b LBB389_130
LBB389_87:
		// crates/vm/src/vm/dispatch/property.rs:577
		self.get_property_from_value(agent, host, registry, frame, receiver, key);
	stp w5, w26, [sp, #8]
	add x0, sp, #368
	str x25, [sp]
	...
	mov x7, x20
	bl lyng_vm::vm::property_access::<impl lyng_vm::vm::Vm>::get_property_from_value
		// crates/vm/src/vm/dispatch/property.rs:579
		self.handle_dispatch_result(agent, frame_depth, frame, property_result)?
	sub x0, x29, #160
	add x5, sp, #368
	mov x1, x21
	...
	cmp x8, x9
	b.ne LBB389_158
		// crates/vm/src/vm/dispatch/property.rs:578
		let Some(value) =
	tbz w5, #0, LBB389_125
		// crates/vm/src/frame.rs:420
		self.metadata.code
	ldr w1, [x20, #4]
		// crates/vm/src/vm/dispatch/property.rs:583
	...
	b LBB389_131
LBB389_92:
		// crates/vm/src/vm/dispatch/property.rs:461
	...
	cmp x8, x9
	b.ne LBB389_158
		// crates/vm/src/vm/dispatch/property.rs:463
...
LBB389_95:
		...
		self.metadata.code
	ldr w2, [x20, #4]
		// crates/vm/src/vm/dispatch/property.rs:464
...
LBB389_96:
	...
	b LBB389_62
LBB389_97:
		// crates/vm/src/vm/dispatch/property.rs:547
...
LBB389_98:
	...
	mov x27, x1
		...
		self.metadata.code
	ldr w1, [x20, #4]
		// crates/vm/src/vm/dispatch/property.rs:554
...
LBB389_101:
	mov w8, #1
		// crates/vm/src/vm/dispatch/property.rs:560
		self.get_property_from_value(agent, host, registry, frame, receiver, key);
	stp w8, w26, [sp, #8]
	str x25, [sp]
	add x0, sp, #320
	...
	mov x7, x20
	bl lyng_vm::vm::property_access::<impl lyng_vm::vm::Vm>::get_property_from_value
		// crates/vm/src/vm/dispatch/property.rs:562
		self.handle_dispatch_result(agent, frame_depth, frame, property_result)?
	sub x0, x29, #160
	add x5, sp, #320
	mov x1, x21
	...
	cmp x8, x9
	b.ne LBB389_158
		// crates/vm/src/vm/dispatch/property.rs:561
		let Some(value) =
	tbz w5, #0, LBB389_125
		// crates/vm/src/frame.rs:420
		self.metadata.code
	ldr w2, [x20, #4]
		// crates/vm/src/vm/dispatch/property.rs:566
...
LBB389_106:
	...
	cbz w10, LBB389_13
	ldur w8, [x29, #-156]
		// crates/vm/src/vm/dispatch/property.rs:1388
	...
	b.ne LBB389_13
		...
		Some(&slot.values)
	ldr x10, [x8, #8]
		// crates/vm/src/vm/dispatch/property.rs:1396
		.get(index as usize)
	...
	str x9, [sp, #32]
		// crates/vm/src/vm/dispatch/property.rs:1394
		let value = view
	cmp x9, x8
	b.eq LBB389_13
		// ~/.rustup/toolchains/stable-aarch64-apple-darwin/lib/rustlib/src/rust/library/alloc/src/vec/mod.rs:1631
...
LBB389_120:
	...
	b LBB389_133
LBB389_122:
		// crates/vm/src/vm/dispatch/property.rs:502
...
Lloh1084:
	...
	stp x8, x10, [x19]
LBB389_126:
		// crates/vm/src/vm/dispatch_handlers/property.rs:157
		}
	add sp, sp, #592
	ldp x29, x30, [sp, #80]
	ldp x20, x19, [sp, #64]
	...
	ret
LBB389_127:
		// crates/vm/src/vm/dispatch/property.rs:511
...
LBB389_130:
		...
		self.metadata.code
	ldr w2, [x20, #4]
		// crates/vm/src/vm/dispatch/property.rs:523
		self.observe_keyed_index_access(agent, frame.code(), feedback_slot, object, index);
	mov x0, x21
	mov x1, x22
	mov x3, x23
...
LBB389_153:
	...
	b LBB389_133
LBB389_155:
		// crates/vm/src/vm/dispatch/property.rs:515
		self.get_property_from_value(agent, host, registry, frame, receiver, key);
	stp wzr, w26, [sp, #8]
	add x0, sp, #272
	str x25, [sp]
	...
	mov x7, x20
	bl lyng_vm::vm::property_access::<impl lyng_vm::vm::Vm>::get_property_from_value
		// crates/vm/src/vm/dispatch/property.rs:517
		self.handle_dispatch_result(agent, frame_depth, frame, property_result)?
	sub x0, x29, #160
	add x5, sp, #272
	mov x1, x21
...
LBB389_161:
	...
	and x10, x9, #0x3fffffff
		// crates/vm/src/vm/dispatch/property.rs:1479
		let value = match handler.slot_location() {
	tbnz w9, #31, LBB389_167
		// crates/vm/src/vm/dispatch/property.rs:1482
...
LBB389_167:
	...
	b.ls LBB389_180
LBB389_168:
		// crates/vm/src/vm/feedback.rs:2183
		if feedback.monomorphic_named_fast_atom == atom.raw()
	ldr w9, [x8, #1148]
	cmp w9, w26
	b.ne LBB389_98
		// crates/vm/src/vm/feedback.rs:2184
	...
	ldr x14, [x8, #1120]
	ldr x8, [x8, #1128]
		// crates/vm/src/vm/dispatch/property.rs:1552
		if record.shape() != handler.receiver_shape()
	ldp w13, w16, [x15, #48]
	ldr x15, [x15, #40]
	cmp w13, #0
...
LBB389_175:
	...
	cmp w10, #1
	b.ne LBB389_98
		// crates/vm/src/vm/dispatch/property.rs:1559
...
LBB389_181:
	ldr x22, [x8, x10, lsl #3]
		// crates/vm/src/vm/dispatch/property.rs:1486
...
LBB389_186:
	...
	and x8, x9, #0x3fffffff
		// crates/vm/src/vm/dispatch/property.rs:1564
		let value = match handler.slot_location() {
	tbnz w9, #31, LBB389_192
		// crates/vm/src/vm/dispatch/property.rs:1567
...
LBB389_194:
	ldr x22, [x9, x8, lsl #3]
		// crates/vm/src/vm/dispatch/property.rs:1571
		self.record_feedback_slot(code, feedback_slot);
	mov x0, x21
	mov x1, x3
	mov x2, x23
