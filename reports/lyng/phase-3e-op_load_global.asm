...
Lfunc_begin358:
		// crates/lyng/vm/src/vm/dispatch_handlers/names.rs:26
	...
	add x1, x8, x6
		// crates/lyng/vm/src/vm/dispatch.rs:295
		if let Some(prefix) = prefix {
	cmp w3, #152
	b.ne LBB358_59
	and x8, x2, #0x7ffffffffffffffe
		// crates/lyng/vm/src/vm/dispatch.rs:298
	...
	ldrh w24, [x1, #4]
		...
		match self {
	cbz w24, LBB358_23
		// crates/lyng/vm/src/vm/dispatch.rs:307
		u16::from(*ra),
	ldrb w10, [x1, #1]
		// ~/.rustup/toolchains/stable-aarch64-apple-darwin/lib/rustlib/src/rust/library/core/src/num/uint_macros.rs:3923
		unsafe { mem::transmute(bytes) }
	...
	mov w9, #6
	stp w9, w10, [sp, #72]
		// crates/lyng/vm/src/vm/dispatch_handlers/names.rs:37
...
LBB358_5:
	...
	ldr w14, [x8, #4]
LBB358_12:
		// crates/lyng/vm/src/vm/dispatch_handlers/names.rs:48
		agent,
	ldp x23, x8, [x20, #88]
	stp x8, x14, [sp, #48]
		// crates/lyng/vm/src/vm/dispatch_handlers/names.rs:49
		*host,
	ldp x9, x8, [x20, #104]
	stp x8, x9, [sp, #32]
		// crates/lyng/vm/src/vm/dispatch_handlers/names.rs:50
		&mut **registry,
	ldr x8, [x20, #120]
	str x8, [sp, #24]
		// crates/lyng/vm/src/frame.rs:465
...
LBB358_13:
	...
	cmp x8, x25
	b.eq LBB358_16
		// crates/lyng/vm/src/vm/names.rs:1643
		if agent.environment_is_global(current) {
	tbz x8, #63, LBB358_27
LBB358_16:
		// crates/lyng/vm/src/vm/names.rs:1647
...
LBB358_26:
	...
	b LBB358_63
LBB358_27:
		// crates/lyng/vm/src/vm/names.rs:1670
	...
	mov x27, x8
LBB358_30:
		// crates/lyng/vm/src/vm/names.rs:535
	...
	cmp x8, x26
	b.ne LBB358_44
		// crates/lyng/vm/src/vm/values.rs:599
	...
	movk x8, #32760, lsl #48
		// crates/lyng/vm/src/vm/values.rs:621
		if value == Value::uninitialized_lexical() {
	cmp x1, x8
	b.ne LBB358_78
		// crates/lyng/ops/src/errors.rs:141
...
LBB358_37:
	...
	cmp x9, x25
	b.eq LBB358_69
		// crates/lyng/env/src/agent/environments.rs:320
		match self.environment_metadata(id) {
	tbnz x9, #63, LBB358_69
		// crates/lyng/env/src/agent/environments.rs:321
...
LBB358_45:
	...
	b.ne LBB358_20
	cbnz w27, LBB358_20
		// crates/lyng/vm/src/vm/dispatch_state.rs:173
...
Lloh922:
	...
	brk #0x1
LBB358_59:
		// crates/lyng/vm/src/vm/dispatch.rs:296
	...
	bl lyng_vm::vm::dispatch::decode_abx_operands_wide
		// crates/lyng/vm/src/vm/dispatch_handlers/names.rs:30
...
LBB358_63:
	...
	stp w22, w8, [x19, #24]
LBB358_64:
		// crates/lyng/vm/src/vm/dispatch_handlers/names.rs:65
		}
	ldp x29, x30, [sp, #320]
	ldp x20, x19, [sp, #304]
	ldp x22, x21, [sp, #288]
...
LBB358_65:
	...
	b.eq LBB358_69
LBB358_66:
		// crates/lyng/vm/src/vm/names.rs:1683
	...
	cbz x8, LBB358_30
LBB358_69:
		// crates/lyng/vm/src/vm/names.rs:540
	...
	b.eq LBB358_89
LBB358_75:
		// crates/lyng/vm/src/vm/names.rs:580
	...
	bl lyng_vm::vm::feedback::<impl lyng_vm::vm::Vm>::try_named_property_load_inline_cache_hit
		// crates/lyng/vm/src/vm/names.rs:579
		if let Some(value) =
	tbz w0, #0, LBB358_81
	mov x25, x1
LBB358_78:
	...
	ldr w8, [x20, #20]
		// crates/lyng/vm/src/vm/dispatch_handlers/names.rs:62
	...
	add w8, w8, w10
		...
		self.ptr.cast().as_non_null_ptr()
	ldr x9, [x9, #24]
		// crates/lyng/vm/src/vm/registers.rs:84
...
LBB358_81:
	ldp x9, x1, [sp, #56]
	ldr w8, [sp, #20]
		// crates/lyng/vm/src/vm/names.rs:586
	...
	tbz w27, #0, LBB358_87
	ldp x5, x0, [sp, #56]
		// crates/lyng/vm/src/vm/names.rs:595
...
LBB358_89:
	...
	b.ne LBB358_96
	ldr x9, [x0, #976]
		// crates/lyng/vm/src/vm/names.rs:550
...
LBB358_101:
	...
	and x9, x8, #0x3fffffff
		// crates/lyng/vm/src/vm/names.rs:553
