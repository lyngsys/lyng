__ZN10lyng_vm2vm17dispatch_handlers10arithmetic6op_add17haf9eb643aea1d0c2E:
L0:
	.loc	178 39 0
	sub	sp, sp, #144
	stp	x28, x27, [sp, #48]
...
L39:
	...
	mov	x2, x22
	mov	x6, x23
	bl	__ZN10lyng_vm2vm17dispatch_handlers10arithmetic11op_add_slow17haf06e6fa30a7daa8E
L40:
L41:
	b	L42
L43:
