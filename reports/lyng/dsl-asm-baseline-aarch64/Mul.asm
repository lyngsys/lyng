...
L24:
	...
	mov	x26, #17179869184
	movk	x26, #32760, lsl #48
L25:
	.loc	19 440 9 is_stmt 1
	ldr	w27, [x21, #20]
L26:
	.loc	178 194 16
	ldr	x24, [x21, #80]
...
L49:
L36:
	.loc	178 0 2 is_stmt 0
	cmp	w9, #0
L50:
	.loc	180 22 9 is_stmt 1
	ccmp	w8, #0, #4, ne
	b.ne	L51
L52:
	.loc	180 0 9 is_stmt 0
	orr	w10, w9, w8
	.loc	180 22 9
	tbnz	w10, #31, L38
L53:
L51:
	.loc	179 2669 26 is_stmt 1
	smull	x28, w8, w9
	cmp	x28, w28, sxtw
L54:
	.loc	178 197 16
