...
- [`reports/js/lyng-js/dsl-handlers/op_bit_and.md`](../dsl-handlers/op_bit_and.md) (Task 5, commit `ce9edf4b`)
- [`reports/js/lyng-js/dsl-handlers/op_shift_left.md`](../dsl-handlers/op_shift_left.md) (Task 6, commit `45c552f6`)
- [`reports/js/lyng-js/dsl-handlers/op_shift_right.md`](../dsl-handlers/op_shift_right.md) (Task 7, commit `ecb056ea`)
...
1. **`inject_opcode_byte` counter-injection discipline** — substrate fix in `crates/lyng-js-vm-dsl/src/lower.rs`. Unblocks honest slow-path-share for all record-smi-shim opcodes.
