...
Lfunc_begin358:
		// crates/lyng-js/vm/src/vm/dispatch_handlers/names.rs:26
	...
	add x1, x8, x6
		// crates/lyng-js/vm/src/vm/dispatch.rs:295
		if let Some(prefix) = prefix {
	cmp w3, #152
	b.ne LBB358_59
	and x8, x2, #0x7ffffffffffffffe
		// crates/lyng-js/vm/src/vm/dispatch.rs:298
	...
	ldrh w24, [x1, #4]
		...
		match self {
	cbz w24, LBB358_23
		// crates/lyng-js/vm/src/vm/dispatch.rs:307
		u16::from(*ra),
	ldrb w10, [x1, #1]
		// ~/.rustup/toolchains/stable-aarch64-apple-darwin/lib/rustlib/src/rust/library/core/src/num/uint_macros.rs:3923
		unsafe { mem::transmute(bytes) }
	...
	mov w9, #6
	stp w9, w10, [sp, #72]
		// crates/lyng-js/vm/src/vm/dispatch_handlers/names.rs:37
...
LBB358_5:
	...
	b.ne LBB358_26
	str x13, [sp, #64]
		// crates/lyng-js/vm/src/vm/values.rs:17
	...
	ldr w14, [x8, #4]
LBB358_12:
		// crates/lyng-js/vm/src/vm/dispatch_handlers/names.rs:48
		agent,
	ldp x23, x8, [x20, #88]
	stp x8, x14, [sp, #48]
		// crates/lyng-js/vm/src/vm/dispatch_handlers/names.rs:49
		*host,
	ldp x9, x8, [x20, #104]
	stp x8, x9, [sp, #32]
		// crates/lyng-js/vm/src/vm/dispatch_handlers/names.rs:50
		&mut **registry,
	ldr x8, [x20, #120]
	str x8, [sp, #24]
		// crates/lyng-js/vm/src/frame.rs:465
...
LBB358_13:
	...
	cmp x8, x25
	b.eq LBB358_16
		// crates/lyng-js/vm/src/vm/names.rs:1643
		if agent.environment_is_global(current) {
	tbz x8, #63, LBB358_27
LBB358_16:
		// crates/lyng-js/vm/src/vm/names.rs:1647
...
LBB358_26:
		...
		Some(&v) => Some(v),
	ldr x11, [x11, #8]
		// crates/lyng-js/vm/src/vm/values.rs:833
		_ => Err(VmError::InvalidAtomConstant {
	orr x10, x12, x14, lsl #32
	b LBB358_63
LBB358_27:
		// crates/lyng-js/vm/src/vm/names.rs:1670
	...
	mov x27, x8
LBB358_30:
		// crates/lyng-js/vm/src/vm/names.rs:535
	...
	cmp x8, x26
	b.ne LBB358_44
		// crates/lyng-js/vm/src/vm/values.rs:599
	...
	movk x8, #32760, lsl #48
		// crates/lyng-js/vm/src/vm/values.rs:621
		if value == Value::uninitialized_lexical() {
	cmp x1, x8
	b.ne LBB358_78
		// crates/lyng-js/ops/src/errors.rs:141
...
LBB358_37:
	...
	cmp x9, x25
	b.eq LBB358_69
		// crates/lyng-js/env/src/agent/environments.rs:320
		match self.environment_metadata(id) {
	tbnz x9, #63, LBB358_69
		// crates/lyng-js/env/src/agent/environments.rs:321
...
LBB358_45:
	...
	b.ne LBB358_20
	cbnz w27, LBB358_20
		// crates/lyng-js/vm/src/vm/dispatch_state.rs:173
...
LBB358_50:
	...
	tbz w27, #0, LBB358_85
	ldr x10, [sp, #64]
		// crates/lyng-js/vm/src/vm/dispatch.rs:529
	...
	mov w10, #80
		...
		unsafe { Some(slice_get_unchecked(slice, self)) }
	madd x8, x8, x10, x9
		// crates/lyng-js/vm/src/vm/dispatch.rs:523
		*frame = stacked;
	ldr q0, [x8]
	str q0, [x20]
	ldp q0, q1, [x8, #48]
...
Lloh922:
	...
	brk #0x1
LBB358_59:
		// crates/lyng-js/vm/src/vm/dispatch.rs:296
	...
	bl lyng_js_vm::vm::dispatch::decode_abx_operands_wide
		// crates/lyng-js/vm/src/vm/dispatch_handlers/names.rs:30
...
LBB358_63:
	...
	stp w22, w8, [x19, #24]
LBB358_64:
		// crates/lyng-js/vm/src/vm/dispatch_handlers/names.rs:65
		}
	ldp x29, x30, [sp, #320]
	ldp x20, x19, [sp, #304]
	ldp x22, x21, [sp, #288]
...
LBB358_65:
	...
	b.eq LBB358_69
LBB358_66:
		// crates/lyng-js/vm/src/vm/names.rs:1683
	...
	cbz x8, LBB358_30
LBB358_69:
		// crates/lyng-js/vm/src/vm/names.rs:540
	...
	ldr x14, [sp, #64]
		...
		match self {
	cbz w24, LBB358_75
		// crates/lyng-js/vm/src/vm/feedback.rs:2085
	...
	ldr x8, [x0]
	cmp x8, #10
		// crates/lyng-js/vm/src/vm/feedback.rs:2086
		match site {
	ccmp x8, #6, #0, ne
	b.eq LBB358_89
LBB358_75:
		// crates/lyng-js/vm/src/vm/names.rs:580
	...
	bl lyng_js_vm::vm::feedback::<impl lyng_js_vm::vm::Vm>::try_named_property_load_inline_cache_hit
		// crates/lyng-js/vm/src/vm/names.rs:579
		if let Some(value) =
	tbz w0, #0, LBB358_81
	mov x25, x1
LBB358_78:
	...
	ldr w8, [x20, #20]
		// crates/lyng-js/vm/src/vm/dispatch_handlers/names.rs:62
	...
	add w8, w8, w10
		...
		self.ptr.cast().as_non_null_ptr()
	ldr x9, [x9, #24]
		// crates/lyng-js/vm/src/vm/registers.rs:84
...
LBB358_81:
	ldp x9, x1, [sp, #56]
	ldr w8, [sp, #20]
		// crates/lyng-js/vm/src/vm/names.rs:586
	...
	tbz w27, #0, LBB358_87
	ldp x5, x0, [sp, #56]
		// crates/lyng-js/vm/src/vm/names.rs:595
...
LBB358_87:
	...
	b LBB358_45
LBB358_89:
		// crates/lyng-js/vm/src/vm/feedback.rs:2087
	...
	b.ne LBB358_96
	ldr x9, [x0, #976]
		// crates/lyng-js/vm/src/vm/names.rs:550
...
LBB358_95:
	...
	b.eq LBB358_101
LBB358_96:
		// crates/lyng-js/vm/src/vm/feedback.rs:2113
	...
	ldr x14, [x0, #1000]
	ldr x9, [x0, #1008]
		// crates/lyng-js/vm/src/vm/dispatch/property.rs:1508
		if record.shape() != handler.receiver_shape()
	ldp w13, w16, [x15, #48]
	ldr x15, [x15, #40]
	cmp w13, #0
...
LBB358_101:
	...
	and x9, x8, #0x3fffffff
		// crates/lyng-js/vm/src/vm/names.rs:553
...
LBB358_108:
	...
	cmp w10, #1
	b.ne LBB358_75
		// crates/lyng-js/vm/src/vm/dispatch/property.rs:1515
...
LBB358_118:
		...
		let offset = low & HANDLER_SLOT_OFFSET_MASK;
	and x9, x8, #0x3fffffff
		// crates/lyng-js/vm/src/vm/dispatch/property.rs:1520
		let value = match handler.slot_location() {
	tbnz w8, #31, LBB358_123
	ldr x14, [sp, #64]
		// crates/lyng-js/vm/src/vm/dispatch/property.rs:1523
