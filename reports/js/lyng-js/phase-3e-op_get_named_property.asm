...
Lfunc_begin390:
		// crates/lyng-js/vm/src/vm/dispatch_handlers/property.rs:31
	...
	mov w24, #6
		...
		u16::from(*rc),
	ldrb w9, [x1, #3]
		// crates/lyng-js/vm/src/vm/dispatch_handlers/property.rs:52
	...
	b.ls LBB390_69
LBB390_5:
		// crates/lyng-js/vm/src/vm/dispatch/property.rs:87
...
LBB390_13:
	...
	cmp x8, x9
		// crates/lyng-js/vm/src/vm/dispatch/property.rs:89
		let value = if let Some(object) = receiver.as_object_ref() {
	ccmp w27, #0, #4, eq
	b.ne LBB390_38
	mov w8, #1
		// crates/lyng-js/vm/src/vm/dispatch/property.rs:177
...
LBB390_17:
	...
	b.ls LBB390_113
		...
		self.ptr.cast().as_non_null_ptr()
	ldr x8, [x22, #24]
		// crates/lyng-js/vm/src/vm/dispatch/property.rs:185
...
LBB390_23:
	...
	ldr q0, [sp, #176]
LBB390_24:
		// crates/lyng-js/vm/src/vm/dispatch_handlers/property.rs:34
		let prefix = state.prefix.take();
	str q0, [x19, #32]
LBB390_25:
		// crates/lyng-js/vm/src/vm/dispatch_handlers/property.rs:67
		}
	ldp x29, x30, [sp, #368]
	ldp x20, x19, [sp, #352]
	ldp x22, x21, [sp, #336]
...
LBB390_38:
	...
	b.eq LBB390_71
LBB390_42:
		// crates/lyng-js/vm/src/vm/dispatch/property.rs:149
	...
	b.ls LBB390_114
		...
		self.ptr.cast().as_non_null_ptr()
	ldr x8, [x22, #24]
		// crates/lyng-js/vm/src/vm/dispatch/property.rs:155
		self.register_stack[target_index] = value;
	str x1, [x8, x23, lsl #3]
LBB390_46:
		// crates/lyng-js/vm/src/frame.rs:425
...
LBB390_50:
	mov w8, #1
		// crates/lyng-js/vm/src/vm/dispatch/property.rs:160
		self.get_property_from_value(agent, host, registry, frame, receiver, key);
	stp w8, w26, [sp, #8]
	str x27, [sp]
	add x0, sp, #80
	...
	ldr x21, [sp, #88]
		...
		self.metadata.code
	ldr w2, [x20, #4]
		// crates/lyng-js/vm/src/vm/dispatch/property.rs:166
...
LBB390_67:
	...
	bl lyng_js_vm::vm::dispatch::decode_abc_operands_wide
		// crates/lyng-js/vm/src/vm/dispatch_handlers/property.rs:35
...
LBB390_71:
	...
	mov x14, x16
	ldr x9, [x0, #976]
		// crates/lyng-js/vm/src/vm/dispatch/property.rs:113
...
LBB390_78:
	...
	and x9, x8, #0x3fffffff
		// crates/lyng-js/vm/src/vm/dispatch/property.rs:116
