__ZN10lyng_js_vm2vm17dispatch_handlers10arithmetic6op_sub17h3141c6fabb0b3e73E:
L0:
	.loc	178 110 0
	sub	sp, sp, #144
	stp	x28, x27, [sp, #48]
...
L39:
	...
	mov	x2, x22
	mov	x6, x23
	bl	__ZN10lyng_js_vm2vm17dispatch_handlers10arithmetic11op_sub_slow17h409cc67e5d0a258fE
L40:
L41:
	b	L42
L43:
