/// Named character reference table from the WHATWG HTML spec.
/// Sorted by name for binary search. Each entry is (name, codepoints).
pub static NAMED_CHAR_REFS: &[(&str, &[char])] = &[
    ("AElig", &['\u{00C6}']),
    ("AElig;", &['\u{00C6}']),
    ("AMP", &['\u{0026}']),
    ("AMP;", &['\u{0026}']),
