...
#[cfg(feature = "opcode-counters")]
#[test]
fn simple_nested_return_avoids_semantic_slow_path() {
    let child_id = BytecodeFunctionId::from_raw(21).unwrap();
    let script_id = BytecodeFunctionId::from_raw(20).unwrap();
    ...
    let unit = CompiledScriptUnit::new(SourceId::new(20), script.id(), vec![script, child]);
    ...
    assert_eq!(
        ...
        1,
        "the nested function Return should use the LLInt frame-return path; only the top-level script Return should exit through the semantic bridge"
    );
}
...
fn nested_return_after_slow_continue_uses_current_caller_register_base() {
    let unit = compile_test_unit(
        ...
        var obj = {
          valueOf: function () {
            var a0=0,a1=1,a2=2,a3=3,a4=4,a5=5,a6=6,a7=7,a8=8,a9=9;
            var a10=10,a11=11,a12=12,a13=13,a14=14,a15=15,a16=16,a17=17,a18=18,a19=19;
            var a20=20,a21=21,a22=22,a23=23,a24=24,a25=25,a26=26,a27=27,a28=28,a29=29;
            var a30=30,a31=31,a32=32,a33=33,a34=34,a35=35,a36=36,a37=37,a38=38,a39=39;
            return 1;
          }
        };
        function child() {
...
#[test]
fn method_condition_return_preserves_caller_receiver_registers() {
    let unit = compile_test_unit(
        5_503,
        r"
        function T() {
        ...
        T.prototype.isHeldOrSuspended = function () {
          return (this.state & 4) != 0 || (this.state == 2);
        };
        function S() {
          this.currentTcb = new T();
        }
        S.prototype.f = function () {
          if (this.currentTcb.isHeldOrSuspended()) {
            this.currentTcb = this.currentTcb.link;
          }
          return this.currentTcb === null;
        };
        var s = new S();
        s.f();
        ",
