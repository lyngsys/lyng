...
//! (B46–B47).
//!
//! Extended by hand during DSL-1 Phase 1.C with inline SMI hit paths
//! for selected hot opcodes: `op_add_smi`, `op_sub`, `op_mul`,
//! `op_bit_and`, `op_shift_left`, `op_shift_right`, `op_increment`,
//! and `op_decrement`.
//!
...
use crate::{
    ...
    branch_nonzero, branch_raw_equal_strict_result, call_rust_probe, call_slow, check_object_ref,
    check_smi, cmp_branch_eq, cmp_branch_ne, cmp_eq_payload, dec_smi_overflow, decode_a, decode_ab,
...
llint_handler! {
    op_get_named_property_dsl, opcode_byte = 77, layout = AbcSlot, length = 6, |a, b, c, slot| {
        ...
        branch_named_own_inline_mode!(c, .slow);
