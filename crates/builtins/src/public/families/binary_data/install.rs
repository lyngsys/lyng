use super::super::{
    BinaryDataFamilyBuiltins, BinaryDataFamilyPrototypes, FamilyInstallContext,
    install_public_builtin_function, install_public_ordinary_object,
};
use lyng_env::Agent;
use lyng_types::{
...
pub(in crate::public) fn install_binary_data_family(
    ...
    BinaryDataFamilyBuiltins {
        ...
        float16_array: constructors.float16_array,
        ...
        array_buffer_detached_getter: buffer_methods.array_buffer_detached_getter,
        array_buffer_max_byte_length_getter: buffer_methods.array_buffer_max_byte_length_getter,
        array_buffer_resizable_getter: buffer_methods.array_buffer_resizable_getter,
        array_buffer_resize: buffer_methods.array_buffer_resize,
        array_buffer_slice: buffer_methods.array_buffer_slice,
        array_buffer_transfer: buffer_methods.array_buffer_transfer,
        ...
        float16_array_prototype: prototypes.float16_array_prototype,
...
fn install_binary_data_constructors(
    ...
    BinaryDataConstructorBuiltins {
        ...
        float16_array: install_with_prototype(
            agent,
            cx,
            float16_array_builtin(),
            prototypes.float16_array_prototype,
        ),
...
fn install_buffer_methods(agent: &mut Agent, cx: FamilyInstallContext) -> BufferMethodBuiltins {
    BufferMethodBuiltins {
        ...
        array_buffer_detached_getter: install(agent, cx, array_buffer_detached_getter_builtin()),
        array_buffer_max_byte_length_getter: install(
            agent,
            cx,
            array_buffer_max_byte_length_getter_builtin(),
        ),
        array_buffer_resizable_getter: install(agent, cx, array_buffer_resizable_getter_builtin()),
        ...
        array_buffer_transfer: install(agent, cx, array_buffer_transfer_builtin()),
        array_buffer_transfer_to_fixed_length: install(
            agent,
            cx,
