...
use lyng_types::{
    ...
    math_acosh_builtin, math_asin_builtin, math_asinh_builtin, math_atan_builtin,
    math_atan2_builtin, math_atanh_builtin, math_cbrt_builtin, math_ceil_builtin,
    ...
    math_imul_builtin, math_log_builtin, math_log1p_builtin, math_log2_builtin, math_log10_builtin,
