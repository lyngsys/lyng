...
pub(super) fn allocate_functions(
    ...
    let constructor = allocate_builtin_function_object(
        ...
        lyng_types::temporal_plain_year_month_builtin(),
        public_builtin_metadata(lyng_types::temporal_plain_year_month_builtin())?,
    ...
    let year_getter = allocate_builtin_function_object(
        ...
        context.function_prototype,
        context.object_prototype,
        lyng_types::temporal_plain_year_month_year_getter_builtin(),
        public_builtin_metadata(lyng_types::temporal_plain_year_month_year_getter_builtin())?,
        None,
    );
    let month_getter = allocate_builtin_function_object(
        ...
        context.function_prototype,
        context.object_prototype,
        lyng_types::temporal_plain_year_month_month_getter_builtin(),
        public_builtin_metadata(lyng_types::temporal_plain_year_month_month_getter_builtin())?,
        None,
    );
    let month_code_getter = allocate_builtin_function_object(
        ...
        context.function_prototype,
        context.object_prototype,
        lyng_types::temporal_plain_year_month_month_code_getter_builtin(),
        public_builtin_metadata(lyng_types::temporal_plain_year_month_month_code_getter_builtin())?,
        None,
    );
    let days_in_month_getter = allocate_builtin_function_object(
        ...
        context.function_prototype,
        context.object_prototype,
        lyng_types::temporal_plain_year_month_days_in_month_getter_builtin(),
    ...
    let days_in_year_getter = allocate_builtin_function_object(
        ...
        context.function_prototype,
        context.object_prototype,
        lyng_types::temporal_plain_year_month_days_in_year_getter_builtin(),
        public_builtin_metadata(
            lyng_types::temporal_plain_year_month_days_in_year_getter_builtin(),
        )?,
        None,
    ...
    let months_in_year_getter = allocate_builtin_function_object(
        ...
        context.function_prototype,
        context.object_prototype,
        lyng_types::temporal_plain_year_month_months_in_year_getter_builtin(),
        public_builtin_metadata(
            lyng_types::temporal_plain_year_month_months_in_year_getter_builtin(),
        )?,
        None,
    ...
    let in_leap_year_getter = allocate_builtin_function_object(
        ...
        context.function_prototype,
        context.object_prototype,
        lyng_types::temporal_plain_year_month_in_leap_year_getter_builtin(),
        public_builtin_metadata(
            lyng_types::temporal_plain_year_month_in_leap_year_getter_builtin(),
        )?,
        None,
    ...
    let era_getter = allocate_builtin_function_object(
        ...
        context.function_prototype,
        context.object_prototype,
        lyng_types::temporal_plain_year_month_era_getter_builtin(),
        public_builtin_metadata(lyng_types::temporal_plain_year_month_era_getter_builtin())?,
        None,
    );
    let era_year_getter = allocate_builtin_function_object(
        ...
        context.function_prototype,
        context.object_prototype,
        lyng_types::temporal_plain_year_month_era_year_getter_builtin(),
        public_builtin_metadata(lyng_types::temporal_plain_year_month_era_year_getter_builtin())?,
        None,
    );
    let calendar_id_getter = allocate_builtin_function_object(
        ...
        context.function_prototype,
        context.object_prototype,
        lyng_types::temporal_plain_year_month_calendar_id_getter_builtin(),
        public_builtin_metadata(
            lyng_types::temporal_plain_year_month_calendar_id_getter_builtin(),
        )?,
        None,
    ...
    let to_string = allocate_builtin_function_object(
        ...
        context.function_prototype,
        context.object_prototype,
        lyng_types::temporal_plain_year_month_to_string_builtin(),
        public_builtin_metadata(lyng_types::temporal_plain_year_month_to_string_builtin())?,
        None,
    );
    let to_json = allocate_builtin_function_object(
        ...
        context.function_prototype,
        context.object_prototype,
        lyng_types::temporal_plain_year_month_to_json_builtin(),
        public_builtin_metadata(lyng_types::temporal_plain_year_month_to_json_builtin())?,
        None,
    );
    let to_locale_string = allocate_builtin_function_object(
        ...
        context.function_prototype,
        context.object_prototype,
        lyng_types::temporal_plain_year_month_to_locale_string_builtin(),
        public_builtin_metadata(lyng_types::temporal_plain_year_month_to_locale_string_builtin())?,
        None,
    );
    let value_of = allocate_builtin_function_object(
        ...
        context.function_prototype,
        context.object_prototype,
        lyng_types::temporal_plain_year_month_value_of_builtin(),
        public_builtin_metadata(lyng_types::temporal_plain_year_month_value_of_builtin())?,
        None,
    );
    let equals = allocate_builtin_function_object(
        ...
        context.function_prototype,
        context.object_prototype,
        lyng_types::temporal_plain_year_month_equals_builtin(),
        public_builtin_metadata(lyng_types::temporal_plain_year_month_equals_builtin())?,
        None,
    );
    let with = allocate_builtin_function_object(
        ...
        context.function_prototype,
        context.object_prototype,
        lyng_types::temporal_plain_year_month_with_builtin(),
        public_builtin_metadata(lyng_types::temporal_plain_year_month_with_builtin())?,
        None,
    );
    let add = allocate_builtin_function_object(
        ...
        context.function_prototype,
        context.object_prototype,
        lyng_types::temporal_plain_year_month_add_builtin(),
        public_builtin_metadata(lyng_types::temporal_plain_year_month_add_builtin())?,
        None,
    );
    let subtract = allocate_builtin_function_object(
        ...
        context.function_prototype,
        context.object_prototype,
        lyng_types::temporal_plain_year_month_subtract_builtin(),
        public_builtin_metadata(lyng_types::temporal_plain_year_month_subtract_builtin())?,
        None,
    );
    let since = allocate_builtin_function_object(
        ...
        context.function_prototype,
        context.object_prototype,
        lyng_types::temporal_plain_year_month_since_builtin(),
        public_builtin_metadata(lyng_types::temporal_plain_year_month_since_builtin())?,
        None,
    );
    let until = allocate_builtin_function_object(
        ...
        context.function_prototype,
        context.object_prototype,
        lyng_types::temporal_plain_year_month_until_builtin(),
        public_builtin_metadata(lyng_types::temporal_plain_year_month_until_builtin())?,
        None,
    );
    let to_plain_date = allocate_builtin_function_object(
        ...
        context.function_prototype,
        context.object_prototype,
        lyng_types::temporal_plain_year_month_to_plain_date_builtin(),
        public_builtin_metadata(lyng_types::temporal_plain_year_month_to_plain_date_builtin())?,
        None,
    );
    let from = allocate_builtin_function_object(
        ...
        context.function_prototype,
        context.object_prototype,
        lyng_types::temporal_plain_year_month_from_builtin(),
        public_builtin_metadata(lyng_types::temporal_plain_year_month_from_builtin())?,
        None,
    );
    let compare = allocate_builtin_function_object(
        ...
        context.function_prototype,
        context.object_prototype,
        lyng_types::temporal_plain_year_month_compare_builtin(),
        public_builtin_metadata(lyng_types::temporal_plain_year_month_compare_builtin())?,
        None,
    );
