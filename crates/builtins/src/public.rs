...
use lyng_types::{
    BuiltinFunctionId, COMPLETION_BUILTIN_NAMESPACE_END, COMPLETION_BUILTIN_NAMESPACE_START,
    CORE_BUILTIN_NAMESPACE_END, CORE_BUILTIN_NAMESPACE_START, EnvironmentRef, ObjectRef,
    PropertyKey, RealmRef, ShapeId, Value, abstract_module_source_builtin,
    abstract_module_source_to_string_tag_getter_builtin, aggregate_error_builtin, array_at_builtin,
    ...
    array_buffer_transfer_to_fixed_length_builtin, array_builtin, array_concat_builtin,
    ...
    async_iterator_dispose_builtin, atomics_add_builtin, atomics_and_builtin,
...
pub use dispatch::{PublicBuiltinDispatchContext, dispatch_builtin};
...
pub struct PublicRealmBuiltins {
    ...
    array_buffer_detached_getter: ObjectRef,
    array_buffer_max_byte_length_getter: ObjectRef,
    array_buffer_resizable_getter: ObjectRef,
    ...
    data_view_get_float16: ObjectRef,
    data_view_set_float16: ObjectRef,
    ...
    float16_array_prototype: ObjectRef,
    ...
    uint8_array_from_base64: ObjectRef,
    uint8_array_from_hex: ObjectRef,
    uint8_array_set_from_base64: ObjectRef,
    uint8_array_set_from_hex: ObjectRef,
    uint8_array_to_base64: ObjectRef,
    uint8_array_to_hex: ObjectRef,
    ...
    async_iterator_dispose: ObjectRef,
    array_iterator_next: ObjectRef,
    map_iterator_next: ObjectRef,
    set_iterator_next: ObjectRef,
    iterator: ObjectRef,
    iterator_from: ObjectRef,
    iterator_concat: ObjectRef,
    iterator_zip: ObjectRef,
    iterator_zip_keyed: ObjectRef,
    ...
    iterator_map: ObjectRef,
    iterator_filter: ObjectRef,
    iterator_take: ObjectRef,
    iterator_drop: ObjectRef,
    iterator_dispose: ObjectRef,
    iterator_flat_map: ObjectRef,
    iterator_helper_next: ObjectRef,
    iterator_helper_return: ObjectRef,
    ...
    string_anchor: ObjectRef,
    string_big: ObjectRef,
    string_blink: ObjectRef,
    string_bold: ObjectRef,
    string_fixed: ObjectRef,
    string_fontcolor: ObjectRef,
    string_fontsize: ObjectRef,
    string_italics: ObjectRef,
    string_link: ObjectRef,
    string_small: ObjectRef,
    string_strike: ObjectRef,
    string_sub: ObjectRef,
    string_sup: ObjectRef,
    regexp: ObjectRef,
    regexp_escape: ObjectRef,
    regexp_prototype: ObjectRef,
    regexp_compile: ObjectRef,
    regexp_legacy_input_getter: ObjectRef,
    regexp_legacy_input_setter: ObjectRef,
    regexp_legacy_last_match_getter: ObjectRef,
    regexp_legacy_last_paren_getter: ObjectRef,
    regexp_legacy_left_context_getter: ObjectRef,
    regexp_legacy_right_context_getter: ObjectRef,
    regexp_legacy_paren1_getter: ObjectRef,
    regexp_legacy_paren2_getter: ObjectRef,
    regexp_legacy_paren3_getter: ObjectRef,
    regexp_legacy_paren4_getter: ObjectRef,
    regexp_legacy_paren5_getter: ObjectRef,
    regexp_legacy_paren6_getter: ObjectRef,
    regexp_legacy_paren7_getter: ObjectRef,
    regexp_legacy_paren8_getter: ObjectRef,
    regexp_legacy_paren9_getter: ObjectRef,
