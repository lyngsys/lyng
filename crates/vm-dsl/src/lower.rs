...
pub(crate) fn lower_handler(ast: HandlerAst) -> Result<TokenStream> {
    ...
    Ok(quote! {
        ...
        pub extern "C" fn #name() -> ! {
            ...
            ::core::arch::naked_asm!(
                "/* len={length} pc={state_pc} pb={state_pb} regs={state_regs} fv={state_fv} objects={state_object_records} object_slots={state_object_slots} depth={state_frame_depth} frame_infos={state_frame_info_base} frame_info_len={state_frame_info_len} reg_top={state_register_stack_top} reg_len={state_register_stack_len} reg_base={state_register_stack_base} call_targets={state_call_targets_base} call_targets_len={state_call_targets_len} prefix={state_prefix} poll={vm_poll} fb_stride_shift={entry_stride_shift} fb_stride={feedback_entry_stride} fb_mode={feedback_mode} fb_call_flags={feedback_call_flags} fb_call_arity={feedback_call_expected_arity} fb_call_no_spread_bit={feedback_call_no_spread_bit} fb_named_handler={feedback_named_handler_bits} fb_named_epoch={feedback_named_epoch} fb_named_aux_bits={feedback_named_aux_bits} fb_named_aux_epoch={feedback_named_aux_epoch} fb_observed={entry_observed} fb_count={feedback_scalar_execution_count} obj_shape={object_shape} obj_prototype={object_prototype} obj_named_slots={object_named_slots} obj_last_epoch={object_last_epoch} obj_inline_slots={object_inline_slots} ctr={vm_counter_base} const_base={vm_const_base} this_value={state_this_value} frame_pb={frame_info_pb_base} frame_regs={frame_info_regs_base} frame_fv={frame_info_fv_base} frame_const={frame_info_const_base} frame_this={frame_info_this_value} frame_pc={frame_info_pc_offset} frame_ret={frame_info_return_register} frame_flags={frame_info_flags} frame_reg_base={frame_info_register_base} frame_reg_len={frame_info_register_len} frame_code={frame_info_code_raw} frame_realm={frame_info_realm_raw} frame_lex={frame_info_lexical_env_raw} frame_var={frame_info_variable_env_raw} frame_private={frame_info_private_env_raw} frame_callee={frame_info_callee_raw} frame_param_init={frame_info_parameter_initializer_end_offset} frame_flags_raw={frame_info_frame_flags_raw} frame_tail_caller={frame_info_tail_caller_raw} frame_tail_strict={frame_info_tail_caller_strict} frame_stride_shift={frame_info_stride_shift} call_callee={call_target_callee_bits} call_pb={call_target_pb_base} call_fv={call_target_fv_base} call_const={call_target_const_base} call_global_this={call_target_global_this} call_code={call_target_code_raw} call_reg_len={call_target_register_len} call_param_count={call_target_parameter_count} call_flags={call_target_flags} call_realm={call_target_realm_raw} call_lex={call_target_lexical_env_raw} call_var={call_target_variable_env_raw} call_private={call_target_private_env_raw} call_callee_raw={call_target_callee_raw} call_param_init={call_target_parameter_initializer_end_offset} call_stride_shift={call_target_stride_shift} call_enabled_bit={call_target_enabled_bit} call_fast_return_bit={call_target_fast_return_safe_bit} call_this_global_bit={call_target_this_global_bit} call_strict_bit={call_target_strict_bit} call_tail_recycle_bit={call_target_tail_call_recycle_safe_bit} fast_return_bit={frame_info_fast_return_safe_bit} frame_strict_bit={frame_info_strict_bit} frame_tail_recycle_bit={frame_info_tail_call_recycle_safe_bit} uninit_lex={value_uninit_lex_bits} exit={exit} */\n",
                #(#template_entries)*
                ...
                state_frame_info_len = const ::lyng_vm::dsl::reg_convention::LLINT_STATE_FRAME_INFO_LEN,
                state_register_stack_top = const ::lyng_vm::dsl::reg_convention::LLINT_STATE_REGISTER_STACK_TOP,
                state_register_stack_len = const ::lyng_vm::dsl::reg_convention::LLINT_STATE_REGISTER_STACK_LEN,
                state_register_stack_base = const ::lyng_vm::dsl::reg_convention::LLINT_STATE_REGISTER_STACK_BASE,
                state_call_targets_base = const ::lyng_vm::dsl::reg_convention::LLINT_STATE_CALL_TARGETS_BASE,
                state_call_targets_len = const ::lyng_vm::dsl::reg_convention::LLINT_STATE_CALL_TARGETS_LEN,
                ...
                feedback_call_flags = const ::lyng_vm::dsl::reg_convention::FEEDBACK_ENTRY_CALL_FLAGS_OFFSET,
                feedback_call_expected_arity = const ::lyng_vm::dsl::reg_convention::FEEDBACK_ENTRY_CALL_EXPECTED_ARITY_OFFSET,
                feedback_call_no_spread_bit = const ::lyng_vm::dsl::reg_convention::FEEDBACK_ENTRY_CALL_NO_SPREAD_BIT,
                ...
                feedback_named_aux_epoch = const ::lyng_vm::dsl::feedback_flat::FEEDBACK_ENTRY_NAMED_AUX_EPOCH_OFFSET,
                ...
                frame_info_register_base = const ::lyng_vm::dsl::reg_convention::LLINT_FRAME_INFO_REGISTER_BASE,
                frame_info_register_len = const ::lyng_vm::dsl::reg_convention::LLINT_FRAME_INFO_REGISTER_LEN,
                frame_info_code_raw = const ::lyng_vm::dsl::reg_convention::LLINT_FRAME_INFO_CODE_RAW,
                frame_info_realm_raw = const ::lyng_vm::dsl::reg_convention::LLINT_FRAME_INFO_REALM_RAW,
                frame_info_lexical_env_raw = const ::lyng_vm::dsl::reg_convention::LLINT_FRAME_INFO_LEXICAL_ENV_RAW,
                frame_info_variable_env_raw = const ::lyng_vm::dsl::reg_convention::LLINT_FRAME_INFO_VARIABLE_ENV_RAW,
                frame_info_private_env_raw = const ::lyng_vm::dsl::reg_convention::LLINT_FRAME_INFO_PRIVATE_ENV_RAW,
                frame_info_callee_raw = const ::lyng_vm::dsl::reg_convention::LLINT_FRAME_INFO_CALLEE_RAW,
                frame_info_parameter_initializer_end_offset = const ::lyng_vm::dsl::reg_convention::LLINT_FRAME_INFO_PARAMETER_INITIALIZER_END_OFFSET,
                frame_info_frame_flags_raw = const ::lyng_vm::dsl::reg_convention::LLINT_FRAME_INFO_FRAME_FLAGS_RAW,
                frame_info_tail_caller_raw = const ::lyng_vm::dsl::reg_convention::LLINT_FRAME_INFO_TAIL_CALLER_RAW,
                frame_info_tail_caller_strict = const ::lyng_vm::dsl::reg_convention::LLINT_FRAME_INFO_TAIL_CALLER_STRICT,
                ...
                frame_info_strict_bit = const ::lyng_vm::dsl::reg_convention::LLINT_FRAME_INFO_STRICT_BIT,
                frame_info_tail_call_recycle_safe_bit = const ::lyng_vm::dsl::reg_convention::LLINT_FRAME_INFO_TAIL_CALL_RECYCLE_SAFE_BIT,
                call_target_callee_bits = const ::lyng_vm::dsl::reg_convention::LLINT_CALL_TARGET_CALLEE_BITS,
                call_target_pb_base = const ::lyng_vm::dsl::reg_convention::LLINT_CALL_TARGET_PB_BASE,
                call_target_fv_base = const ::lyng_vm::dsl::reg_convention::LLINT_CALL_TARGET_FV_BASE,
                call_target_const_base = const ::lyng_vm::dsl::reg_convention::LLINT_CALL_TARGET_CONST_BASE,
                call_target_global_this = const ::lyng_vm::dsl::reg_convention::LLINT_CALL_TARGET_GLOBAL_THIS,
                call_target_code_raw = const ::lyng_vm::dsl::reg_convention::LLINT_CALL_TARGET_CODE_RAW,
                call_target_register_len = const ::lyng_vm::dsl::reg_convention::LLINT_CALL_TARGET_REGISTER_LEN,
                call_target_parameter_count = const ::lyng_vm::dsl::reg_convention::LLINT_CALL_TARGET_PARAMETER_COUNT,
                call_target_flags = const ::lyng_vm::dsl::reg_convention::LLINT_CALL_TARGET_FLAGS,
                call_target_realm_raw = const ::lyng_vm::dsl::reg_convention::LLINT_CALL_TARGET_REALM_RAW,
                call_target_lexical_env_raw = const ::lyng_vm::dsl::reg_convention::LLINT_CALL_TARGET_LEXICAL_ENV_RAW,
                call_target_variable_env_raw = const ::lyng_vm::dsl::reg_convention::LLINT_CALL_TARGET_VARIABLE_ENV_RAW,
                call_target_private_env_raw = const ::lyng_vm::dsl::reg_convention::LLINT_CALL_TARGET_PRIVATE_ENV_RAW,
                call_target_callee_raw = const ::lyng_vm::dsl::reg_convention::LLINT_CALL_TARGET_CALLEE_RAW,
                call_target_parameter_initializer_end_offset = const ::lyng_vm::dsl::reg_convention::LLINT_CALL_TARGET_PARAMETER_INITIALIZER_END_OFFSET,
                call_target_stride_shift = const ::lyng_vm::dsl::reg_convention::LLINT_CALL_TARGET_STRIDE_SHIFT,
                call_target_enabled_bit = const ::lyng_vm::dsl::reg_convention::LLINT_CALL_TARGET_ENABLED_BIT,
                call_target_fast_return_safe_bit = const ::lyng_vm::dsl::reg_convention::LLINT_CALL_TARGET_FAST_RETURN_SAFE_BIT,
                call_target_this_global_bit = const ::lyng_vm::dsl::reg_convention::LLINT_CALL_TARGET_THIS_GLOBAL_BIT,
                call_target_strict_bit = const ::lyng_vm::dsl::reg_convention::LLINT_CALL_TARGET_STRICT_BIT,
                call_target_tail_call_recycle_safe_bit = const ::lyng_vm::dsl::reg_convention::LLINT_CALL_TARGET_TAIL_CALL_RECYCLE_SAFE_BIT,
