...
#[allow(unused_variables)]
#[unsafe(no_mangle)]
pub extern "C" fn op_load_undefined_slow_rs(
    state: *mut crate::dsl::llint_state::LlIntState,
    a: u32,
    bx: u32,
) -> crate::dsl::slow_path::SlowPathReturn {
    ...
    let outcome = crate::vm::semantics::loads::op_load_undefined_semantic(&mut dispatch, args);
    dispatch.translate_outcome(outcome)
}
