...
impl PlainDateTimeBootstrapContext {
...
#[derive(Clone, Copy)]
pub(super) struct PlainDateTimeFunctions {
...
#[derive(Clone, Copy)]
pub(super) struct PlainDateTimePrototypeProperties {
...
pub(super) fn install_temporal_object_property(
    ...
    plain_date_time_key: PropertyKey,
