...
pub(in crate::public) fn install_string_family(
    ...
    StringFamilyBuiltins {
        ...
        string_anchor: install_public_builtin_function(agent, cx, string_anchor_builtin(), None),
        string_big: install_public_builtin_function(agent, cx, string_big_builtin(), None),
        string_blink: install_public_builtin_function(agent, cx, string_blink_builtin(), None),
        string_bold: install_public_builtin_function(agent, cx, string_bold_builtin(), None),
        string_fixed: install_public_builtin_function(agent, cx, string_fixed_builtin(), None),
        string_fontcolor: install_public_builtin_function(
            agent,
            cx,
            string_fontcolor_builtin(),
            None,
        ),
        string_fontsize: install_public_builtin_function(
            agent,
            cx,
            string_fontsize_builtin(),
            None,
        ),
        string_italics: install_public_builtin_function(agent, cx, string_italics_builtin(), None),
        string_link: install_public_builtin_function(agent, cx, string_link_builtin(), None),
        string_small: install_public_builtin_function(agent, cx, string_small_builtin(), None),
        string_strike: install_public_builtin_function(agent, cx, string_strike_builtin(), None),
        string_sub: install_public_builtin_function(agent, cx, string_sub_builtin(), None),
        string_sup: install_public_builtin_function(agent, cx, string_sup_builtin(), None),
    }
}
...
pub(in crate::public) fn string_builtin_object(
    ...
    [
        ...
        (string_anchor_builtin(), builtins.string_anchor),
        (string_big_builtin(), builtins.string_big),
        (string_blink_builtin(), builtins.string_blink),
        (string_bold_builtin(), builtins.string_bold),
        (string_fixed_builtin(), builtins.string_fixed),
        (string_fontcolor_builtin(), builtins.string_fontcolor),
        (string_fontsize_builtin(), builtins.string_fontsize),
        (string_italics_builtin(), builtins.string_italics),
        (string_link_builtin(), builtins.string_link),
        (string_small_builtin(), builtins.string_small),
        (string_strike_builtin(), builtins.string_strike),
        (string_sub_builtin(), builtins.string_sub),
        (string_sup_builtin(), builtins.string_sup),
    ]
    .into_iter()
...
impl StringDescriptorAtoms {
    fn new(agent: &mut Agent) -> Self {
        Self {
            ...
            trim_left: agent.atoms_mut().intern("trimLeft"),
            trim_right: agent.atoms_mut().intern("trimRight"),
            anchor: agent.atoms_mut().intern("anchor"),
            big: agent.atoms_mut().intern("big"),
            blink: agent.atoms_mut().intern("blink"),
            bold: agent.atoms_mut().intern("bold"),
            fixed: agent.atoms_mut().intern("fixed"),
            fontcolor: agent.atoms_mut().intern("fontcolor"),
            fontsize: agent.atoms_mut().intern("fontsize"),
            italics: agent.atoms_mut().intern("italics"),
            link: agent.atoms_mut().intern("link"),
            small: agent.atoms_mut().intern("small"),
            strike: agent.atoms_mut().intern("strike"),
            sub: agent.atoms_mut().intern("sub"),
            sup: agent.atoms_mut().intern("sup"),
...
fn string_prototype_method_specs(
    ...
    [
        ...
        (atoms.trim_left, string_trim_start_builtin()),
        (atoms.trim_right, string_trim_end_builtin()),
        (atoms.anchor, string_anchor_builtin()),
        (atoms.big, string_big_builtin()),
        (atoms.blink, string_blink_builtin()),
        (atoms.bold, string_bold_builtin()),
        (atoms.fixed, string_fixed_builtin()),
        (atoms.fontcolor, string_fontcolor_builtin()),
        (atoms.fontsize, string_fontsize_builtin()),
        (atoms.italics, string_italics_builtin()),
        (atoms.link, string_link_builtin()),
        (atoms.small, string_small_builtin()),
        (atoms.strike, string_strike_builtin()),
        (atoms.sub, string_sub_builtin()),
        (atoms.sup, string_sup_builtin()),
    ]
}
