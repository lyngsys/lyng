...
pub(in crate::public) fn install_function_family(
    ...
    FunctionFamilyBuiltins {
        ...
        function_call: install_public_builtin_function(agent, cx, function_call_builtin(), None),
        function_apply: install_public_builtin_function(agent, cx, function_apply_builtin(), None),
        function_bind: install_public_builtin_function(agent, cx, function_bind_builtin(), None),
        ...
        generator_next: install_public_builtin_function(agent, cx, generator_next_builtin(), None),
...
fn install_function_prototype_descriptors(
    ...
    let descriptors = [
        ...
        builtin_function_atom_property(WellKnownAtom::call.id(), function_call_builtin()),
        builtin_function_atom_property(WellKnownAtom::apply.id(), function_apply_builtin()),
        builtin_function_atom_property(WellKnownAtom::bind.id(), function_bind_builtin()),
        builtin_function_atom_property(WellKnownAtom::toString.id(), function_to_string_builtin()),
        ...
        accessor_atom_property(
            atoms.caller,
            Some(internal_throw_type_error_builtin()),
            Some(internal_throw_type_error_builtin()),
...
fn install_async_generator_prototype_descriptors(
    ...
    let descriptors = [
        ...
        builtin_function_atom_property(atoms.next, async_generator_next_builtin()),
        builtin_function_atom_property(
            WellKnownAtom::r#return.id(),
            async_generator_return_builtin(),
        ),
        builtin_function_atom_property(atoms.throw, async_generator_throw_builtin()),
        data_symbol_property(
...
pub(in crate::public) fn function_builtin_object(
    ...
    [
        (function_builtin(), builtins.function),
        (function_prototype_builtin(), builtins.function_prototype),
        (function_call_builtin(), builtins.function_call),
        (function_apply_builtin(), builtins.function_apply),
        (function_bind_builtin(), builtins.function_bind),
        (function_to_string_builtin(), builtins.function_to_string),
        (
            function_symbol_has_instance_builtin(),
            builtins.function_symbol_has_instance,
        ),
        (async_function_builtin(), builtins.async_function),
        (
            async_generator_function_builtin(),
        ...
        (generator_function_builtin(), builtins.generator_function),
        (generator_next_builtin(), builtins.generator_next),
        (generator_return_builtin(), builtins.generator_return),
        (generator_throw_builtin(), builtins.generator_throw),
    ]
    .into_iter()
